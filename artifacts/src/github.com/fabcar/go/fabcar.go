...
// Car :  Define the car structure, with 5 properties.  Structure tags are used by encoding/json library
type Car struct {
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	cars := []Car{
		...
		Car{Make: "Ford", Model: "Mustang", Colour: "red", Owner: "Brad", State: "Ready"},
		Car{Make: "Hyundai", Model: "Tucson", Colour: "green", Owner: "Jin Soo", State: "Ready"},
		Car{Make: "Volkswagen", Model: "Passat", Colour: "yellow", Owner: "Max", State: "Sold"},
		Car{Make: "Tesla", Model: "S", Colour: "black", Owner: "Adriana", State: "Sold"},
		...
		Car{Make: "Fiat", Model: "Punto", Colour: "violet", Owner: "Pari", State: "Ready"},
		Car{Make: "Tata", Model: "Nano", Colour: "indigo", Owner: "Valeria", State: "Sold"},
		Car{Make: "Holden", Model: "Barina", Colour: "brown", Owner: "Shotaro", State: "Sold"},
	}
...
func (s *SmartContract) createPrivateCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	if len(carInput.State) == 0 {
		return shim.Error("state field must be a non-empty string")
	}
...
func (s *SmartContract) createCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var car = Car{Make: args[1], Model: args[2], Colour: args[3], Owner: args[4], State: args[5]}
